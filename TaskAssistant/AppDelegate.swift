...
//  TaskAssistant
//
//  Created by framgia on 6/11/14.
//  Copyright (c) 2014 __LongIndie___. All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var applicationFilesDirectory: NSURL {
        // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "long.indie.TaskAssistant" in the user's Application Support directory.
        let fileManager = NSFileManager.defaultManager()
        let urls = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
        let appSupportURL: AnyObject = urls[urls.endIndex - 1]
        return appSupportURL.URLByAppendingPathComponent("long.indie.TaskAssistant")
    }
    ...
    var managedObjectModel: NSManagedObjectModel {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("TaskAssistant", withExtension: "momd")
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("TaskAssistant.storedata")
